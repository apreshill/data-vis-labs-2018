...
- Now mouse up to "Addins" and select `xaringan`: Infinite Moon Reader. 
    - This option does live preview of slides (every time you update and save the Rmd document, the slides will be automatically reloaded in RStudio Viewer.)
...
- Use markdown: `![](path/to/my/image.jpg)` (no quotes!)

--

- Or (path in quotes now!):
...
- This image now is saved in a subfolder of my *current* "project" working directory.
